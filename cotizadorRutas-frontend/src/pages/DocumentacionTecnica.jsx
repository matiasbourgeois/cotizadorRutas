      ...
      <ScrollArea style={{ height: 'calc(100vh - 60px)' }}>
        <div className="doc-tech">
          ...
          <div className="dt-cover">
            ...
            <span className="dt-badge">DOCUMENTO CONFIDENCIAL · {new Date().getFullYear()}</span>
          </div>
          ...
          <div className="dt-toc">
            ...
            <div className="dt-toc-grid">
              ...
              <a href="#rrhh"><span className="dt-toc-num">04</span> Motor: Recurso Humano</a>
          ...
          <div className="dt-section" id="rrhh">
            <div className="dt-section-header">
              ...
              <div>
                ...
                <h2>Motor de Costos: Recurso Humano</h2>
              </div>
            </div>

            <p>El motor más complejo del sistema. Calcula cuánto cuesta el colaborador asignado a la misión, con lógica diferenciada para viajes cortos y largos.</p>
            ...
            <div className="dt-formula">
              ...
              valor_jornada = sueldo_ajustado ÷ 22<br/><br/>
            ...
            <div className="dt-card">
              ...
              <div className="dt-formula">
                ...
                <span className="comment">// Se calcula jornada completa + horas extra:</span><br/>
                minutos_extra_por_dia = máximo(0, tiempo_diario_total − 480)<br/>
                costo_extra_mes = (minutos_extra ÷ 60) × valor_hora × dias_trabajo<br/><br/>
                <strong>costo_base = (valor_jornada × dias_trabajo) + costo_extra_mes</strong><br/><br/>
            ...
            <div className="dt-formula">
              ...
              &nbsp;&nbsp;costo_indirecto = base_remunerativa × (cargas_sociales_% ÷ 100)<br/><br/>
              <strong>SI Contratado:</strong><br/>
              &nbsp;&nbsp;subtotal_bruto = base_remunerativa + adicional_fijo + viatico_km<br/>
              &nbsp;&nbsp;costo_indirecto = subtotal_bruto × (overhead_% ÷ 100)<br/><br/>
              <strong>total_rrhh = base_remunerativa + adicional_fijo + viatico_km + costo_indirecto</strong>
            </div>

            <div className="dt-tip dt-tip--cyan">
              <span className="dt-tip-icon">💡</span>
              <div><strong>Diferencia Empleado vs Contratado:</strong> Para empleados, las cargas sociales se calculan solo sobre la base remunerativa. Para contratados, el overhead se calcula sobre el subtotal bruto incluyendo viáticos y adicionales no remunerativos.</div>
            </div>
          </div>
          ...
          <div className="dt-section" id="consolidacion">
            ...
            <div className="dt-formula">
              ...
              &nbsp;&nbsp;adicional_peligrosa = kms_mensuales_totales × $250<br/><br/>
            ...
            <table className="dt-table">
              ...
              <tbody>
                ...
                <tr><td><strong>costoAdicionalPeligrosa</strong></td><td>Recargo $250/km para carga peligrosa</td></tr>
          ...
          <div className="dt-section" id="constantes">
            ...
            <table className="dt-table">
              ...
              <tbody>
                <tr><td><strong>TIEMPO_CARGA_DESCARGA</strong></td><td>30</td><td>minutos</td><td>Se suma a la duración de cada viaje</td><td><span className="dt-badge dt-badge--emerald">Sí</span></td></tr>
                <tr><td><strong>UMBRAL_JORNADA_COMPLETA</strong></td><td>180</td><td>minutos</td><td>Si la misión supera este valor → costo fijo 100%</td><td><span className="dt-badge dt-badge--emerald">Sí</span></td></tr>
                ...
                <tr><td><strong>DIAS_LABORALES_MES</strong></td><td>22</td><td>días</td><td>Divisor para calcular costo fijo diario y jornada</td><td><span className="dt-badge dt-badge--emerald">Sí</span></td></tr>
                ...
                <tr><td><strong>FACTOR_GNC</strong></td><td>1.15</td><td>×</td><td>El GNC rinde 15% más que nafta</td><td><span className="dt-badge dt-badge--emerald">Sí</span></td></tr>
                ...
                <tr><td><strong>COSTO_KM_PELIGROSA</strong></td><td>250</td><td>$/km</td><td>Recargo por seguro y protocolo especial</td><td><span className="dt-badge dt-badge--emerald">Sí</span></td></tr>
                <tr><td><strong>ANTIGÜEDAD_MAX_DEPRECIACIÓN</strong></td><td>10</td><td>años</td><td>Solo se deprecian vehículos de ≤10 años</td><td><span className="dt-badge dt-badge--rose">No</span></td></tr>
                ...
                <tr><td><strong>KM_MINIMO_CORTO</strong></td><td>150</td><td>km</td><td>Mínimo kilómetros a pagar en servicio corto</td><td><span className="dt-badge dt-badge--rose">No</span></td></tr>
                <tr><td><strong>KM_MINIMO_DEDICADO</strong></td><td>350</td><td>km</td><td>Mínimo kilómetros a pagar en servicio dedicado</td><td><span className="dt-badge dt-badge--rose">No</span></td></tr>
              </tbody>
            </table>
          </div>
