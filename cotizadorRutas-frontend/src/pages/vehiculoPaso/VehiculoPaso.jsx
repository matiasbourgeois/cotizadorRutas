                    ...
                    <Stack gap="xl" style={{ flexGrow: 1 }}>
                        ...
                        <Table.ScrollContainer minWidth={600} style={{ flexGrow: 1 }}>
                            <Table highlightOnHover verticalSpacing="sm">
                                <Table.Thead>
                                    <Table.Tr>
                                        <SortableTableHeader sorted={sortBy === 'marca'} reversed={reverseSortDirection} onSort={() => setSorting('marca')}>Vehículo</SortableTableHeader>
                                        <SortableTableHeader sorted={sortBy === 'tipoVehiculo'} reversed={reverseSortDirection} onSort={() => setSorting('tipoVehiculo')}>Tipo</SortableTableHeader>
                                        <SortableTableHeader sorted={sortBy === 'capacidadKg'} reversed={reverseSortDirection} onSort={() => setSorting('capacidadKg')}>Capacidad</SortableTableHeader>
                                        <SortableTableHeader sorted={sortBy === 'rendimientoKmLitro'} reversed={reverseSortDirection} onSort={() => setSorting('rendimientoKmLitro')}>Rendimiento</SortableTableHeader>
